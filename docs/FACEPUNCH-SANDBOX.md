...
This profile deliberately disables the AppleJack Framework document bridge and
...
The dashboard's Config tab, Profile, can switch between this profile and the AppleJack Framework
